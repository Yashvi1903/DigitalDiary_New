...
public class Entry {
    ...
    public static class Builder {
        ...
        public Entry build() {
            ...
            if (diary == null)
                throw new IllegalStateException("Diary is required");
            if (user == null)
    ...
    public static void menu(Diary diary, User user) {
        while (true) {
            try {
                EntryRepository repo = new FileEntryRepository();
                repo.loadAll(diary,user);
                ...
                switch (choice) {
                    case 1:
                        App.clearScreen();
                        AddNewEntry.AddEntry(diary, user,repo);
                        break;
                    case 2:
                        App.clearScreen();
                        ViewPastEntry.showEntry(diary, user,repo);
                        break;
                    case 3:
                        App.clearScreen();
                    ...
                    case 4:
                        App.clearScreen();
                        DeleteEntry.deleteEntry(diary, user,repo);
                        break;
                    case 5:
                        App.clearScreen();
                        EditEntry.edit(diary, user,repo);
                        break;
                    case 6:
                        App.clearScreen();
                        DownloadEntry.downloadMenu(diary, user,repo);
                        break;
                    case 7:
                        App.clearScreen();
